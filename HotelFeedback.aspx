<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="HotelFeedback.aspx.cs" Inherits="HotelFeedback" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table class="nav-justified">
        ...
        <tr>
            <td class="auto-style22">&nbsp;</td>
            <td>
                <asp:ListView ID="lvAccommodation" runat="server" GroupItemCount="3" GroupPlaceholderID="groupPlaceholder1" ItemPlaceholderID="itemPlaceholder1">
                    <LayoutTemplate>
                        <table>
    ...
    <table class="nav-justified">
        <tr>
            ...
            <td>
                <asp:GridView ID="AcmReviews" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
