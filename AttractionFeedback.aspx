<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AttractionFeedback.aspx.cs" Inherits="AttractionFeedback" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table class="nav-justified">
        ...
        <tr>
            <td class="auto-style22">&nbsp;</td>
            <td>
                <asp:ListView ID="lvAttraction" runat="server" GroupItemCount="3" GroupPlaceholderID="groupPlaceholder1" ItemPlaceholderID="itemPlaceholder1" >
                    <LayoutTemplate>
                        <table>
                        ...
                        <td>
                            <table class="auto-style1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="lblModel" runat="server" Text='<%# Eval("Address") %>'></asp:Label>
                                    </td>
                                </tr>
                                <tr>
    ...
    <table class="nav-justified">
        <tr>
            ...
            <td><asp:GridView ID="attReviews" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
