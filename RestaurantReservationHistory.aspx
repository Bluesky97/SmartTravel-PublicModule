<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RestaurantReservationHistory.aspx.cs" Inherits="RestaurantReservationHistory" %>
    ...
    <table class="nav-justified">
        ...
        <tr>
            ...
            <td>
                ...
                &nbsp;&nbsp;&nbsp;
                <asp:Button ID="btnSearch" runat="server" Height="42px" Text="Search" Width="142px" ForeColor="White" BackColor="#009688" Font-Bold="True" Font-Names="Tahoma" Font-Size="Medium" CausesValidation="False" OnClick="btnSearch_Click" />
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
                ...
                <table class="nav-justified">
                    ...
                    <tr>
                        ...
                        <td class="auto-style4">
                            ...
                            <br />
                            <asp:DetailsView ID="dlCustomer" runat="server" AutoGenerateRows="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="151px" HorizontalAlign="Center" Width="297px">
