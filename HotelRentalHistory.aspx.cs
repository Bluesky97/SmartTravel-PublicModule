...
public partial class HotelRentalHistory : System.Web.UI.Page
{
            ...
            if (e.NewValues["ItemBookingStatus"].ToString() == "Pending" || e.NewValues["ItemBookingStatus"].ToString() == "Approved" || e.NewValues["ItemBookingStatus"].ToString() == "Rejected")
            {
                ...
                if (e.NewValues["ItemBookingStatus"].ToString() == "Approved")
                {
                    ...
                    try
                    {
                        ...
                        msg.Body = "Your booking to stay at " + item.RoomID.Hotel.Name + " has been confirmed. Check out the updated status on our website. Your booking ID is " + item.BookingID.BookingID + "\r\n";
                    ...
                    Dividend dividend = new Dividend("", DateTime.Now, DateTime.Now, item.Price, "Pending", null, item.RoomID.Hotel, item);
                ...
                else if (e.NewValues["ItemBookingStatus"].ToString() == "Rejected")
                {
                    ...
                    msg.Body = "We're sorry to inform you that your booking to stay at " + item.RoomID.HID.Name + " has been rejected. Check out the updated status on our website. Your booking ID is " + item.BookingID.BookingID + "\r\n";
                    msg.Body += "Thanks you for choosing SmartTravel";
                    client.Send(msg);
                }
            }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        gvHistory.Visible = false;
        //Getting current signed in user
        Hotel accOwner = (Hotel)Session["userHotel"];
