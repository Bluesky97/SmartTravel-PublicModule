<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="HotelRentalHistory.aspx.cs" Inherits="HotelRentalHistory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table class="nav-justified">
        ...
        <tr>
            ...
            <td>
                ...
                &nbsp;&nbsp;&nbsp;
                <asp:Button ID="btnSearch" runat="server" Height="42px" Text="Search" Width="142px" Font-Bold="True" Font-Names="Tahoma" Font-Size="Medium" ForeColor="White" BackColor="#009688" CausesValidation="False" OnClick="btnSearch_Click" />
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            ...
            <td>
                <asp:GridView ID="gvUpcoming" runat="server" AutoGenerateColumns="False" CssClass="table table-nonfluid .table-striped .table-condensed table-responsive" CellPadding="3" Height="209px" HorizontalAlign="Center" Width="1026px" OnRowCancelingEdit="gvUpcoming_RowCancelingEdit" OnRowCommand="gvUpcoming_RowCommand" OnRowEditing="gvUpcoming_RowEditing" OnRowUpdating="gvUpcoming_RowUpdating" Font-Names="Tahoma" Font-Size="Small" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px">
                    <Columns>
                        ...
                        <asp:BoundField DataField="RoomID.Hotel.Name" HeaderText="Hotel Name" ReadOnly="True">
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                        <asp:BoundField DataField="RoomID.RoomID" HeaderText="Room " ReadOnly="True">
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
    ...
    <table class="nav-justified">
        ...
        <tr>
            <td class="auto-style5">&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td>
                <asp:GridView ID="gvFeedback" runat="server" AutoGenerateColumns="False" CssClass="table table-nonfluid .table-striped .table-condensed table-responsive" CellPadding="4" Height="199px" HorizontalAlign="Center" Width="1071px" OnRowCancelingEdit="gvFeedback_RowCancelingEdit" OnRowCommand="gvHistory_RowCommand" OnRowEditing="gvFeedback_RowEditing" OnRowUpdating="gvFeedback_RowUpdating" ForeColor="#333333" GridLines="None" Font-Names="Tahoma" Font-Size="Small" AllowPaging="True" OnPageIndexChanging="gvFeedback_PageIndexChanging" PageSize="6">
                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                    <Columns>
